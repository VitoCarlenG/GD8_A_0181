package com.example.gd8_a_0181;
...
import com.example.gd8_a_0181.api.ApiClient;
import com.example.gd8_a_0181.api.ApiInterface;
...
public class AddEditActivity extends AppCompatActivity {
            ...
            public void onResponse(Call<MahasiswaResponse> call, Response<MahasiswaResponse> response) {
                if(response.isSuccessful()) {
                    ...
                    try {
                        ...
                        Toast.makeText(AddEditActivity.this, jObjError.getString("message"), Toast.LENGTH_SHORT).show();
                    }catch (Exception e) {
    ...
    private void createMahasiswa() {
        ...
        call.enqueue(new Callback<MahasiswaResponse>() {
            ...
            public void onResponse(Call<MahasiswaResponse> call, Response<MahasiswaResponse> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(AddEditActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
